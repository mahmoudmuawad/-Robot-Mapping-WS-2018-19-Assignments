...
% Read sensor readings, i.e. odometry  --> the motion command ut and range-bearing sensor x1,y1  - x2, y2
...
for t = 1:size(data.timestep, 2)
    ...
    % Update the pose of the robot based on the motion model ,# code motion model
    # stop here derive odometry motion model and code it  
